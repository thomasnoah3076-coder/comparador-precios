...
DB_PATH_TRACKER = BASE_DIR / "database" / "tracker.db"

DB_PATH_EXCHANGE_RATES = BASE_DIR / "database" / "exchange_rates.json"
...
# URL de la API para obtener la tasa de cambio de divisas.
